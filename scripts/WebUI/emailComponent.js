...
async function addReply(reply) {
    ...
    const con = `
      <div class="p-4 ml-6 flex gap-4 generate-reply-container">
    ...
    const content = `<div class="my-extension flex items-center justify-center">
      <div class="compose-container fade-in bg-white rounded-lg">
          ...
          <div class="p-2 gap-2 create-compose hidden items-center align-middle bg-white rounded-lg">
              ...
              <img src="https://img.icons8.com/?size=100&id=g8ltXTwIfJ1n&format=png&color=000000" class="border bg-black hover:bg-white px-3 p-2 rounded-lg cursor-pointer generate" width="50px" height="50px"/>
          </div>
      </div>
      <button id="toggleButton" class="p-2 m-2 bg-gray-300 rounded-full absolute bottom-0 right-0">&#x25B6;</button>
  </div>`;
