...
async function showAlert(message){
    const content =`<div id="alert-1" class="hidden fixed top-20 left-1/2 transform -translate-x-1/2 -translate-y-full mt-4 items-center p-4 mb-4text-green-800 rounded-lg bg-green-400 dark:bg-green-400 dark:text-black transition-transform duration-500 ease-in-out w-[40%]" role="alert" style="z-index: 9999;">
  <!--- Icon for the alert -->
